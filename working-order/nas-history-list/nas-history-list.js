let HistoryDialog = function () {
    ...
    function init() {
        ...
        function initCloseButton() {
            $('.dialog_nas_history .dialog_close').click(function () {
                dismiss();
            })
        }
    }
    ...
    function updateList() {
        ...
        let list = $('.dialog_nas_history .history_list');
        list.html('');
    ...
    function makeNasHistyoryTable(history) {
        let title = $('.dialog_nas_history .dialog_department');
        let list = $('.dialog_nas_history .history_list');
        let body = $('.dialog_nas_history .dialog_body');
        let container = $('.dialog_nas_history .dialog_container');
