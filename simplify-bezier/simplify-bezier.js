var paper = function (self, undefined) {
    ...
    Base.inject({
        ...
        statics: {
            ...
            serialize: function (obj, options, compact, dictionary) {
                ...
                return isRoot && dictionary.length > 0 ? [['dictionary', dictionary.definitions], res] :
                    res;
            },
    ...
    var Matrix = Base.extend({
        ...
        toString: function () {
            ...
            return '[[' + [f.number(this._a), f.number(this._c),
					f.number(this._tx)].join(', ') + '], [' + [f.number(this._b), f.number(this._d),
			...
			internal ? 1 : 0
                ...
                statics: {
                    ...
                    _getBounds: function (items, matrix, options) {
                        ...
                        return {
                            rect: isFinite(x1) ?
                                new Rectangle(x1, y1, x2 - x1, y2 - y1) : new Rectangle(),
                            nonscaling: nonscaling
                        };
                    }
                }
    ...
    var Segment = Base.extend({
        ...
        _serialize: function (options, dictionary) {
            var point = this._point,
                ...
                obj = selection || this.hasHandles() ? [point, this._handleIn, this._handleOut] :
                point;
            if (selection)
                obj.push(selection);
    ...
    var Curve = Base.extend({
            ...
            _serialize: function (options, dictionary) {
                return Base.serialize(this.hasHandles() ? [this.getPoint1(), this.getHandle1(), this.getHandle2(),
            ...
            statics: {
                getValues: function (segment1, segment2, matrix, straight) {
                    var p1 = segment1._point,
                        ...
                        x2 = p2.x,
                        y2 = p2.y,
                        values = straight ? [x1, y1, x1, y1, x2, y2, x2, y2] : [
					x1, y1,
					x1 + h1._x, y1 + h1._y,
					x2 + h2._x, y2 + h2._y,
					x2, y2
			...
			[x9, y9, x8, y8, x6, y6, x3, y3]
                ...
                getPart: function (v, from, to) {
                    ...
                    return flip ? [v[6], v[7], v[4], v[5], v[2], v[3], v[0], v[1]] :
                        v;
                },
                    ...
                    classify: function (v) {
                        ...
                        function type(type, t1, t2) {
                            ...
                            return {
                                ...
                                roots: t1Ok || t2Ok ?
                                    t1Ok && t2Ok ?
                                    t1 < t2 ? [t1, t2] : [t2, t1] : [t1Ok ? t1 : t2] : null
                            };
                        }
            ...
            function handleCurve(v) {
                ...
                if (po <= max(o0, o1, o2, o3) && po >= min(o0, o1, o2, o3)) {
                    var a0 = v[ia + 0],
                        ...
                        paR < min(a0, a1, a2, a3) ? [v] : Curve.getMonoCurves(v, dir),
                        res;
            ...
            return Base.each(types, function (properties, type) {
                ...
                _serialize: function (options, dictionary) {
                    ...
                    return Base.serialize(
                        ...
                        components : [this._type].concat(components),
                        options, true, dictionary);
                },
